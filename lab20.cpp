#include"lab21.h"// [Missing Code 1] Include header file.
...
int main(){
	...
	Equipment armor(25,-2,2);// [Missing Code 2]  Create Equipment axes, shield and armor here
	...
	else if(eq == '4') hero.equip(&armor);// [Missing Code 3] Equip a selected equipment to the hero. 
